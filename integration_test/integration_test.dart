...
void main() {
  testWidgets('End-to-end test', (WidgetTester tester) async {
    ...
    expect(
        find.textContaining(
            'Református énekeskönyv (48-as fekete és 21-es kék)'),
        findsWidgets);
    ...
    final iconButton = find.byKey(const Key('_MyHomePageState.IconButton'));
    ...
    final textFormFieldWidgetController =
        (textFormField.evaluate().first.widget as TextFormField).controller;
    ...
    await tester.enterText(textFormField, '514');
    await tester.testTextInput.receiveAction(TextInputAction.done);
    await tester.pumpAndSettle();
    expect(find.text('Hibás adat'), findsOneWidget);
    ...
    await tester.enterText(textFormField, '513');
    await tester.testTextInput.receiveAction(TextInputAction.done);
    await tester.pumpAndSettle();
    await tester.tap(nextVerse);
    await tester.tap(nextVerse);
