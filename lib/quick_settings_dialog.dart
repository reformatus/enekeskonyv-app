                ...
                child: FadingEdgeScrollView.fromScrollView(
                  child: ListView(
                    ...
                    children: [
                      ...
                      ListTile(
                        ...
                        trailing: DropdownButton<ThemeMode>(
                          ...
                          items: ThemeMode.values
                              .map(
                                (brightnessSetting) => DropdownMenuItem(
                      ...
                      const SettingsSectionTitle('Navigáció', subtitle: true),
                      ListTile(
                        title: const Text(
    ...
    return ListTile(
      ...
      onTap: () {
        ...
        Navigator.of(context).push(
          MaterialPageRoute(
            builder: (context) {
              return SongPage(book: book, songKey: songKey);
            },
          ),
        );
      },
...
class SettingsSectionTitle extends StatelessWidget {
  ...
  const SettingsSectionTitle(this.title, {this.subtitle = false, super.key});
